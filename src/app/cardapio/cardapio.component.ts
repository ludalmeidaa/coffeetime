...
export class CardapioComponent {
  ...
  cardapioItem: CardapioItem[] = [
    ...
    /////// PÃES
    { nome: 'Pão de queijo grande', preco: '5,00', descricao: "Pão de queijo grande, crocante por fora e macio por dentro.", categoria: 'PÃES', imagemItem: "https://receitasdepesos.com.br/wp-content/uploads/2024/06/6968-4.jpg.webp"},
    ...
    { nome: 'Pão na chapa com requeijão/tradicional', preco: '4,50', descricao: "Pão francês tostado na chapa, opção tradicional ou com requeijão cremoso.", categoria: 'PÃES', imagemItem: "https://www.sabornamesa.com.br/media/k2/items/cache/66121bc28c9d23f8a6cd26cc53117b58_L.jpg"},
    ...
    { nome: 'Chá', preco: '4,50', descricao: "Chá quentinho em sabores variados, ideal para um momento de calma e conforto.", categoria: 'BEBIDAS QUENTES', imagemItem: "https://s2-ge.glbimg.com/p7F_1Oxq9XqdME0jouwdboMhSoo=/0x0:1254x836/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_bc8228b6673f488aa253bbcb03c80ec5/internal_photos/bs/2021/A/b/09cekQQaqNJZeZZf2yZg/istock-647196742.jpg"},
    ...
    { nome: 'Monster', preco: '9,00', descricao: "Bebida energética Monster. Para dar aquele gás no dia.", categoria: 'BEBIDAS FRIAS', imagemItem: "https://www.foodbusinessnews.net/ext/resources/2024/08/12/Monster-lead.jpg?height=667&t=1723464876&width=1080"},
